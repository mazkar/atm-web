...
def public_route_prefix = 'dev-web-siab'
...
def host_okd = 'https://okd.mylab-siab.com:8443'
def ocp_project = 'web-atm'
def env = 'siab-dev'

def pull_secret = 'default-dockercfg-hktkk'
   ...
   stage('OpenShift Build'){
    ...
    stage('OpenShift Deployment'){
        sh """
            ...
            -p ENV_VAR='ENV_VAR' -p CUST_VAR='ENV_VAR' -p ENV2_VAR='ENV2_VAR' -p CUST2_VAR='CUST2_VAR' \
            | oc ${oc_command} ${oc_mode} -n ${ocp_project} -f -
            sleep 5
            """
