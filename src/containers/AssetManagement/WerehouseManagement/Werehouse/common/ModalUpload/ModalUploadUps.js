...
const ModalUploadUps = ({ isOpen, onClose, onSuccesUpload }) => {
  const {
    root,
    modal,
    paper,
  ...
  const handleSubmit = (event) => {
    ...
    axios({
      method: "post",
      url: `${constants.ASSET_MANAGEMENT_SERVICE}/uploadMasterUps`,
      data: formData,
      headers: {
...
ModalUploadUps.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccesUpload: PropTypes.func.isRequired,
};

export default ModalUploadUps;
