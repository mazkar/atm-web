...
const ModalUploadDvr = ({ isOpen, onClose, onSuccesUpload }) => {
  const {
    root,
    modal,
    paper,
  ...
  const handleSubmit = (event) => {
    ...
    axios({
      method: "post",
      url: `${constants.ASSET_MANAGEMENT_SERVICE}/uploadMasterDvr`,
      data: formData,
      headers: {
...
ModalUploadDvr.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccesUpload: PropTypes.func.isRequired,
};

export default ModalUploadDvr;
