...
import { ReactComponent as TrashIcon } from "../../../../../ProjectManagement/TimelineProject/assets/trashIcon.svg";
...
const ModalDeleteSuccess = ({ isOpen, onClose, onLeave }) => {
  const {
    modal,
    paper,
    closeIcon,
