  ...
  return (
    <Box className={classes.root}>
      <Grid container spacing={2} style={{ marginTop: 30 }}>
          ...
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs={6}>
              <Typography
                style={{ fontWeight: 600, color: constansts.color.dark }}
              >
                {unix(dummyData.tglProses / 1000).format("DD/MM/YYYY")}
              </Typography>
            </Grid>
          </Grid>
        </Grid>
          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <InputText
                ...
                onChange={(e) => setValuePembayaran(e.target.value)}
              />
            </Grid>
            <Grid item xs={6}>
              <InputText
        ...
        <Typography className={classes.title}>Attachment</Typography>
          ...
          {dummyFile.map((item) => (
            <Grid item xs={6}>
              ...
              >
                ...
                {item.uploaded ? (
                  <CheckIcon style={{ size: 32, marginLeft: 10 }} />
                ) : (
                  <TimesIcon style={{ marginLeft: 10 }} />
                )}
              </div>
            </Grid>
          ))}
