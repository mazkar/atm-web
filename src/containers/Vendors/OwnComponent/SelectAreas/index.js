...
export default function SelectAreas(props) {
  ...
  const {dataSelect, getValue, isSelectAll, labelSelectAll, handleSelectAll, isSelectAllVal} = props;
...
SelectAreas.propTypes = {
  ...
  isSelectAllVal: PropTypes.bool,
  labelSelectAll: PropTypes.string,
  handleSelectAll: PropTypes.func,
};
SelectAreas.defaultProps = {
  dataSelect: dataDummy,
  isSelectAll: false,
  isSelectAllVal: false,
