...
const ModalNotFound = ({ isOpen, onClose, idAtm, typeValue, message }) => {
    ...
    >
      <Box className={classes.paper}>
        ...
        <Grid container direction="column" style={{marginTop: 10,}}>
          <Grid item>
            <Typography className={classes.title} >{title(typeValue)} Data Not Found</Typography>
          </Grid>
          <Grid item>
...
ModalNotFound.defaultProps = {
  message: "Please retry or select existing data",
};
