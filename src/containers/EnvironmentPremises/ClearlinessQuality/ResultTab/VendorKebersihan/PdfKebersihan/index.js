      ...
      <Page size="A4" wrap style={{ paddingBottom: 125 }}>
        ...
        <View style={styles.container}>
          <View style={styles.section}>
            ...
            <QnAItemSecondary data={dataQnA.kebersihan} />
          </View>
          <View style={styles.section}>
            <Text
              style={{ fontStyle: "bold", fontSize: 14, paddingBottom: 10 }}
            ...
            <QnAItemSecondary data={dataQnA.potensiModusKejahatan} />
          </View>
          <View style={styles.section}>
            <Text
              style={{ fontStyle: "bold", fontSize: 14, paddingBottom: 10 }}
          ...
          <View style={styles.section}>
            ...
            <QnAItemSecondary data={dataQnA.cekKondisiRuangan} />
          </View>
        </View>
...
PdfKebersihan.propTypes = {
  dataQnA: PropTypes.object,
  dataTopInfo: PropTypes.object,
};
PdfKebersihan.defaultProps = {
  dataTopInfo: dummyData.dataTopInfo,
  dataQnA: dummyData.dataQnA,
};
export default PdfKebersihan;
