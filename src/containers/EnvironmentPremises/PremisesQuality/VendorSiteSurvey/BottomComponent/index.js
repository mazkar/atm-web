...
const BottomComponent = (props) => {
  ...
  const { data, typeChecklist, dataMaintenance } = props;
  const { dataMainSite, setDataMainSite } = useState();

  // console.log("sekk??????", typeChecklist);
 /*  useEffect(() => {}, []);
  function hendledatamain() {
    if (typeChecklist === "Site Quality") {
      setDataMainSite(data.vendorSiteSurvey);
    } else {
      setDataMainSite(data.maintenanceSurveiPromosi);
    }
  }
  useEffect(() => {
    hendledatamain();
      ...
      <Grid container direction="row" spacing={4}>
        ...
        <Grid item xs={9}>
          <Paper className={classes.paper}>
            ...
            >
              {typeChecklist === "Site Quality" ? (
                <QnAItem data={data.vendorSiteSurvey} />
              ) : (
            ...
            >
              {typeChecklist === "Site Quality" ? (
                ...
                <QnAItem data={dataMaintenance.modusKejahatan} />
              )}
            </TabPanel>
            <TabPanel
              value={activeMenu}
            ...
            >
              {typeChecklist === "Site Quality" ? (
                ...
                <QnAItem data={dataMaintenance.mediaPromosi} />
              )}
            </TabPanel>
            <TabPanel
              value={activeMenu}
            ...
            >
              {typeChecklist === "Site Quality" ? (
                ...
                <QnAItem data={dataMaintenance.kondisiRuangan} />
              )}
            </TabPanel>
          </Paper>
