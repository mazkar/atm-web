                  ...
                  <Table size='small'>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.picLocation)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                  ...
                  <Table size='small'>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.picRequest)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.populasiAtm)}{' '}
                          ATM
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                  ...
                  <Table size='small'>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.luasAreaAtm)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                  ...
                  <Table size='small'>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.kebersihan)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : stripeMedia(data.mediaPromotion)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
