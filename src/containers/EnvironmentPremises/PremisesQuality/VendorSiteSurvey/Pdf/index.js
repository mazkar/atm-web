  ...
  return (
    <Document>
      <Page size="A4" wrap style={{paddingBottom: 100}}>
        ...
        <View style={styles.container}>
          <View style={styles.section}>
            <QnAItemSecondary data={dataQnA.vendorSiteSurvey}/>
          </View>
        </View>
        <View style={styles.container}>
          <View style={styles.section}>
        ...
        <View style={styles.container}>
          <View style={styles.section}>
            <QnAItemSecondary data={dataQnA.mediaPromosi}/>
          </View>
        </View>
        <View style={styles.container}>
          <View style={styles.section}>
            <QnAItemSecondary data={dataQnA.kondisiRuangan}/>
          </View>
        </View>
