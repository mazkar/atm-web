...
function SearchAtm(props) {
  const { classes, onChange, label, onActionClicked, atmID } = props;
  ...
  return (
    <div>
      <div className="new-atm-container">
        <div className="input-form">
          <label style={{ fontSize: "13px", fontWeight: 400 }}>{label}</label>
