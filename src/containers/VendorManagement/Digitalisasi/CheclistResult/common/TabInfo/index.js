                  ...
                  <Table size='small'>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.condition)}{' '}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.picLocationName)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.picLocationEmail)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.landlordName)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.landlordTelephoneNumber)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.landlordEmail)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.codeGfms)}
                      </TableCell>
                    </TableRow>
                  </Table>
                </Grid>
                  ...
                  <Table size='small'>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.locationMode)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.machineType)}
                      </TableCell>
                    </TableRow>
                  </Table>
                </Grid>
