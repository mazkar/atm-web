...
const TabelResultChecklist = (props) => {
  ...
  return (
    <div style={withTabs ? styleWithTab : null}>
      {isLoadData ? (
...
TabelResultChecklist.propTypes = {
  ...
  withFilterApplied: PropTypes.bool,
};

TabelResultChecklist.defaultProps = {
  rowsPerPage: 10,
  totalRows: null,
  cellType: "string",
  data: [],
  ...
  withFilterApplied: false,
};

export default TabelResultChecklist;
