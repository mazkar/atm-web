  ...
  return (
    <Document>
      <Page size="A4" wrap style={{paddingBottom: 125}}>
        ...
        <View style={styles.container}>
          <View style={styles.section}>
            <Text style={{fontStyle: "bold", fontSize: 14, paddingBottom: 10}}>FLM Replenishment</Text>
            <QnAItemSecondary data={dataQnA.flmRpl}/>
          </View>
          <View style={styles.section}>
            <Text style={{fontStyle: "bold", fontSize: 14, paddingBottom: 10}}>Modus Kejahatan</Text>
