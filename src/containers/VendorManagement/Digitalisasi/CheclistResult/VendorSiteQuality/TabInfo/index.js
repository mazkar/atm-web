                    ...
                    {dataPhotos.length > 0 ? (
                      <Slider {...settingsSlider}>
                        {dataPhotos.map((image) => {
                          return (
                            <ImagesSlider filePath={image.path} filename={image.header} />
                          );
                        })}
                      </Slider>
                    ) : (
                      <Typography style={{fontStyle: "italic", color: "#BCC8E7"}}>No images</Typography>
                    )}
                  </div>
                </Grid>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(
                            data.picLocationTelephoneNumber
                          )}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                  ...
                  <Table size='small'>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.idRequester)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.machineType)}
                      </TableCell>
                    </TableRow>
                  </Table>
                </Grid>
