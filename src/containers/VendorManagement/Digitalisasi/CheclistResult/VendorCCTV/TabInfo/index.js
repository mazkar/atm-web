        ...
        if (data.implementationInformation.locationMachinePhotos !== null) {
          setDataPhotos((prevData) => {
            return [
              ...prevData,
              {
                path: data.implementationInformation.locationMachinePhotos,
                header: 'Posisi Mesin',
              },
            ];
          });
        ...
        if (data.implementationInformation.locationFrontMachinePhoto !== null) {
          setDataPhotos((prevData) => {
            return [
              ...prevData,
              {
                path: data.implementationInformation.locationFrontMachinePhoto,
                header: 'Tampak Muka',
              },
            ];
          });
        ...
        <Grid container spacing={2} alignItems='center' justify='space-between'>
          <Grid item sm={4}>
            <Typography style={{ fontSize: 28 }}>
                ATM {isEmpty(data) ? '-' : data.implementationInformation.atmId}
            </Typography>
          </Grid>
          <Grid item sm={4}>
                  ...
                  <Table size='small'>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.atmCondition)}{' '}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.locationName)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.locationAddress)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.picLocation)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(
                            data.implementationInformation.picLocationTelephoneNumber
                          )}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.emailPicLoc)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.signerLooMouName)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.signerLooMouPhone)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.signerLooMouEmail)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.gmfsCode)}
                      </TableCell>
                    </TableRow>
                  </Table>
                </Grid>
                  ...
                  <Table size='small'>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.picRequester)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.picPhonePicReq)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.initialBranch )}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.categoryLoc)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.locationType)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.atmPopulation)}{' '}
                          ATM
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.atmType)}
                      </TableCell>
                    </TableRow>
                  </Table>
                </Grid>
                  ...
                  <Table size='small'>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.boothType)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.buildingLarge)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.publicAccessibility)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.publicAccessbilityNote)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                    ...
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.aroundAtm)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                          :{' '}
                        {isEmpty(data) ? '-' : setStringValue(data.implementationInformation.denom)}
                      </TableCell>
                    </TableRow>
                  </Table>
                </Grid>
                  ...
                  <Table size='small'>
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.acType)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.cleanType)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.commType)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : stripeMedia(data.implementationInformation.mediaPromotion)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.mediaPromotionNote)}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
                      ...
                      <TableCell className={classes.tableCell}>
                        ...
                        {isEmpty(data)
                          ? '-'
                          : setStringValue(data.implementationInformation.electricNumber)}{' '}
                      </TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width='40%' className={classes.tableCell}>
