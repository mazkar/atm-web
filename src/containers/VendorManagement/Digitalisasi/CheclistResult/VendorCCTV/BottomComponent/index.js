...
import { cctvSurvey } from "../../../../../VendorManagement/Digitalisasi/CheclistResult/common/DataDummy";
  ...
  return (
    <div className={classes.root}>
      <Grid container direction="row" spacing={4}>
        <Grid item xs={3}>
          <SideBar
            title="Vendor CCTV External"
            items={[
              {
                label: "Vendor CCTV External",
                count: 10,
                value: 0,
              },
            ]}
