...
const tableData1 = [
  {
    label: 'ID ATM',
    content: [{ label: 'Type', value: 'A2313' }],
  },
  {
    label: 'Status Lokasi',
    content: [{ label: 'Keberadaan', value: 'Aktif' }],
  },
  {
    label: 'Type Lokasi',
    content: [{ label: 'Keberadaan', value: 'ATM Center' }],
  },
  {
    label: 'ATM Lain di Lokasi Sama',
    content: [{ label: 'Keberadaan', value: 'Ada' }],
  },
  {
    label: 'ATM Sekitar 100m',
    content: [
      { label: 'Keberadaan', value: 'Ada' },
      { label: 'Type', value: 'CIMB Niaga, BRI, BCA, BNI' },
    ],
  },
  {
    label: 'Bayar Parkir Akses ATM',
    content: [{ label: 'Keberadaan', value: 'Tidak' }],
  },
  {
    label: 'Foto Seluruh Body Mesin',
    content: [{ src: 'https://via.placeholder.com/100x70' }],
  },
  {
    label: 'Foto Seluruh Ruangan Dari Dekat',
    content: [{ src: 'https://via.placeholder.com/100x70' }],
  },
  {
    label: 'Foto Ruangan ATM Dari Jauh, Terlihat Sekitar',
    content: [{ src: 'https://via.placeholder.com/100x70' }],
  },
];
