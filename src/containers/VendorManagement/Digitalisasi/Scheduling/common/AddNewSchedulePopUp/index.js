...
const AddNewSchedulePopUp = ({ isOpen, onClose, onSuccessSubmit }) => {
  ...
  function validateForm(){
    ...
    if(!dataRequest.startDate) {handleError('startDate', true); errorCount += 1;}
    else handleError('startDate', false)
    
    // validate end date input
    if(!dataRequest.endDate) {handleError('endDate', true); errorCount += 1;}
    else handleError('endDate', false)

    // validate interval input
    if(!dataRequest.interval) {handleError('interval', true); errorCount += 1;}
    else handleError('interval', false)
  ...
  function handleChangeVendor(vendorId){
              ...
              <Grid item xs={6}>
                <Grid container direction="column">
                  ...
                  <Grid item>
                    ...
                    { errorValidation.atmId ? <ErrorComponent label="This Field is Required!" /> : null }
                  </Grid>
                </Grid>
              </Grid>
              <Grid item xs={6}>
              ...
              <Grid item xs={6}>
                <Grid container direction="column">
                  ...
                  <Grid item style={{ marginTop: 5 }}>
                    ...
                    />
                    { errorValidation.startDate ? <ErrorComponent label={'Please Enter Start Date!'} /> : null }
                  </Grid>
                </Grid>
              </Grid>
              <Grid item xs={6}>
                <Grid container direction="column">
                  ...
                  <Grid item style={{ marginTop: 5 }}>
                    ...
                    />
                    { errorValidation.endDate ? <ErrorComponent label='Please Enter End Date!' /> : null }
                  </Grid>
                </Grid>
              </Grid>
            </Grid>
              ...
              <Grid item xs={6}>
                <Grid container direction="column">
                  ...
                  <Grid item style={{ marginTop: 5 }}>
                    ...
                    />
                    { errorValidation.interval ? <ErrorComponent label='Please Enter Interval!' /> : null }
                  </Grid>
                </Grid>
              </Grid>
              <Grid item xs={6}>
...
AddNewSchedulePopUp.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccessSubmit: PropTypes.func.isRequired,
};

export default AddNewSchedulePopUp;