...
import { doUploadSchedule } from '../../../../ApiServices';
...
const PopUpUploadSchedule = ({ isOpen, onClose, onSuccesUpload }) => {
  const {
    root,
    modal,
    paper,
  ...
  const handleSubmit = (event) => {
    ...
    if(!fileFile){
      ...
      doUploadSchedule(loaderHandler, formData)
        .then((response) => {
  ...
  return (
    <div className={root}>
      ...
      <PopupSucces isOpen={isSuccess} onClose={onSuccessClose} message="Upload Schedule Success!"/>
    </div>
  );
};

PopUpUploadSchedule.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccesUpload: PropTypes.func.isRequired,
};

export default PopUpUploadSchedule;
