...
const TopComponent = ({ content, handleMessage, onMessageEnter }) => {
  ...
  const fieldInformasiPenawaran = [
    ...
    { label1: 'Tgl Request', value1: c.requestDate != null
      ? moment.unix(c.requestDate / 1000).format("DD-MM-YYYY")
      : "-", label2: 'ID Location', value2: c.locationId != null ? c.locationId : "-" },
    {
      label1: 'User Request',
    ...
    { label1: 'Due Date', value1: c.dueDate != null
      ? moment.unix(c.dueDate / 1000).format("DD-MM-YYYY")
      : "-", label2: 'Area', value2: c.area },
