                        ...
                        <Grid container justify='space-between'>
                          ...
                          <Grid item xs={6}>
                            <SmallInput
                              style={{ height: '23px' }}
                              onChange={(e) =>
                                handleChangeState(e.target.value, 'engineerTelephoneNumber')
                              }
                      ...
                      <Grid item style={{ marginTop: 30 }}>
                        <Grid container justify='space-between'>
                          ...
                          <Grid item xs={6}>
                            <SmallInput
                              style={{ height: '23px' }}
                              onChange={(e) => handleChangeState(e.target.value, 'linkVideo')}
                  ...
                  <Grid item xs={6}>
                    <Grid container direction='column'>
                      <Grid item style={{ marginTop: 10 }}>
                        <Grid container justify='space-between'>
                          ...
                          <Grid item xs={6}>
                            <SmallInput
                              style={{ height: '23px' }}
                              onChange={(e) => handleChangeState(e.target.value, 'partNumber')}
                      ...
                      <Grid item style={{ marginTop: 13 }}>
                        <Grid container justify='space-between'>
                          <Grid item style={{ marginTop: 9 }} xs={6}>
                      ...
                      <Grid item style={{ marginTop: 13 }}>
                        <Grid container justify='space-between'>
                          ...
                          <Grid item xs={6}>
                            <SmallInput
                              style={{ height: '23px' }}
                              onChange={(e) => handleChangeState(e.target.value, 'picInstall')}
                      ...
                      <Grid item style={{ marginTop: 10 }}>
                        <Grid container justify='space-between'>
                          ...
                          <Grid item xs={6}>
                            <SmallInput
                              style={{ height: '23px'}}
                              onChange={(e) => handleChangeState(e.target.value, 'brandTypeName')}
                      ...
                      <Grid item style={{ marginTop: 20 }}>
                        <Grid container justify='space-between'>
                          ...
                          <Grid item xs={6}>
                            <SmallInput
                              style={{ height: '23px' }}
                              onChange={(e) => handleChangeState(e.target.value, 'stickerId')}
                      ...
                      <Grid item style={{ marginTop: 20 }}>
                        <Grid container justify='space-between'>
                          ...
                          <Grid item xs={6}>
                            <SmallInput
                              style={{ height: '23px' }}
                              onChange={(e) => handleChangeState(e.target.value, 'version')}
                      ...
                      >
                        <Grid container direction='column' alignItems='center'>
                          {dataBast.photoSLMVendor ? (
                            ...
                            <ImageSelector
                              title='Tanda Tangan'
                              onChange={(e) => setPhotoSLM(e.target.files[0])}
                ...
                <Grid container style={{ marginTop: 240 }} justify='space-between'>
                  <Grid item>
                    <Button
                      ...
                      onClick={() => window.location.assign('/vendor-management/orders/kebutuhan')}
