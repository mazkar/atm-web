    ...
    <Document>
      <Page style={styles.page} wrap>
        <View style={styles.section}>
              ...
              <View style={styles.column}>
                <View style={styles.row}>
                  ...
                  <View style={styles.column}>
                    ...
                    <View style={styles.th}>
                      <Text style={styles.textField}>: {data.requesterName}</Text>
                    </View>
                    <View style={styles.th}>
                      <Text style={styles.textField}>: {data.engineerTelephoneNumber}</Text>
                    </View>
                    <View style={styles.th}>
                  ...
                  <View style={styles.column}>
                    {data.vendorDetails.map((item) => {
                      if (dataChecked[item.check]) {
                        return (
                          <View style={styles.row}>
                            <View style={styles.columnOtherNoPad}>
                              <View style={styles.th}>
              ...
              <View style={styles.column}>
                <View style={styles.row}>
                  <View style={styles.column}>
                    ...
                    <View style={[styles.th, {paddingTop: data.locationName.length > 16 ? 30 : 15}]}>
          ...
          {/* Foto Sebelum */}
          <Text style={{ fontSize: 13, fontFamily: 'Times-Bold' }}>Foto Sebelum</Text>
          <View style={styles.rowfoto}>
            <View style={styles.column}>
              <MinioImageComponent filePath={data.photoFrontCimb} style={styles.imageAfter} />
              <Text style={styles.ketFoto}>Sebelum 1</Text>
              <Text style={styles.textValue}>{data.datefrontCimb}</Text>
            </View>
            <View style={styles.column}>
              <MinioImageComponent filePath={data.photoRightCimb} style={styles.imageAfter} />
              <Text style={styles.ketFoto}>Sebelum 2</Text>
              <Text style={styles.textValue}>{data.dateRightCimb}</Text>
            </View>
            <View style={styles.column}>
              <MinioImageComponent filePath={data.photoLeftCimb} style={styles.imageAfter} />
              <Text style={styles.ketFoto}>Sebelum 3</Text>
              <Text style={styles.textValue}>{data.dateLeftCimb}</Text>
            </View>
            <View style={styles.column}>
              <MinioImageComponent filePath={data.photoRearCimb} style={styles.imageAfter} />
          ...
          >
            <Text style={{ fontSize: 13, fontFamily: 'Times-Bold' }}>Foto Sesudah</Text>
            <View style={styles.rowfoto}>
              <View style={styles.column}>
                <MinioImageComponent filePath={data.photoFrontVendor} style={styles.imageAfter} />
                <Text style={styles.ketFoto}>Sesudah 1</Text>
                <Text style={styles.textValue}>{data.dateFrontVendor}</Text>
              </View>
              <View style={styles.column}>
                <MinioImageComponent filePath={data.photoRightVendor} style={styles.imageAfter} />
                <Text style={styles.ketFoto}>Sesudah 2</Text>
                <Text style={styles.textValue}>{data.dateRightVendor}</Text>
              </View>
              <View style={styles.column}>
                <MinioImageComponent filePath={data.photoLeftVendor} style={styles.imageAfter} />
                <Text style={styles.ketFoto}>Sesudah 3</Text>
                <Text style={styles.textValue}>{data.dateLeftVendor}</Text>
              </View>
              <View style={styles.column}>
                <MinioImageComponent filePath={data.photoRearVendor} style={styles.imageAfter} />
          ...
          <View style={styles.row}>
            ...
            <View style={styles.column}>
              {data.photoFLMVendor && (
                <View style={styles.columnVendor}>
                  <MinioImageComponent filePath={data.photoFLMVendor} style={styles.imageAfter} />
            ...
            {/* <View style={styles.column}>
              {data.photoSLMVendor && (
                <View style={styles.columnVendor}>
                  <MinioImageComponent filePath={data.photoSLMVendor} style={styles.imageAfter} />
                  <Text style={(styles.textField)}>SLM Vendor</Text>
                </View>
              )}
            </View> */}
          </View>
          <View style={styles.rowfooter}>
            ...
            <Text style={styles.textFooter}>
              ...
              Telp 299 72 400 Fax 7486 7959 SWIFT BNIAIDJA www.cimb.com
            </Text>
          </View>
        </View>
      </Page>
