...
const BottomComponent = ({ content, handleMessage, onMessageEnter, onSubmit,onViewNotEditSurat, }) => {
  ...
  const totalHargaBarang = dataBarang.reduce((prev, cur) => {
    return cur.qty != null && cur.harga != null ? prev + cur.qty * cur.harga : prev;
  }, 0);
  ...
  return (
    <div>
      <Grid container direction='row' spacing={4}>
                ...
                <Box className={classes.boxStyle}>
                  ...
                  <Grid container direction='row' style={{ marginTop: 15, marginBottom: 15 }}>
                    <Grid item xs={4} style={{ textAlign: 'right' }}>
                      <Typography style={{ color: '#2B2F3C', fontWeight: 600, paddingRight: 10 }}>
                        Total Biaya Jasa
                      </Typography>
                    </Grid>
                    <Grid item xs={8} style={{ textAlign: 'right' }}>
                      <Typography style={{ color: '#2B2F3C', fontWeight: 600, paddingRight: 45 }}>
                    ...
                    <Grid container direction="column" style={{marginTop: 20}}>
                      <Grid item>
                        <Grid container direction="row">
                          ...
                          <Grid item xs={2}/>
                          <Grid item xs={5}><Typography style={{ color: "#2B2F3C", fontWeight: 600, textAlign: 'right'}}><TextRupiah value={subTotal} /></Typography></Grid>
                        </Grid>
                      </Grid>
                      <Grid item>
                        <Grid container direction="row">
                          ...
                          <Grid item xs={1}><Typography style={{ color: "#2B2F3C", fontWeight: 400}}>:</Typography></Grid>
                          <Grid item xs={2}><Typography style={{ color: "#2B2F3C", fontWeight: 600}}><span style={{border: "1px solid #BCC8E7", borderRadius: 8, padding: 15, fontWeight: "normal", color:" #8D98B4", fontStyle: "italic"}}>{c.ppn}</span> % </Typography></Grid>
                          <Grid item xs={5}><Typography style={{ color: "#2B2F3C", fontWeight: 600, textAlign: 'right'}}><TextRupiah value={(c.ppn/100) * subTotal} /></Typography></Grid>
                        </Grid>
                      </Grid>
                      <Grid item>
                        <Grid container direction="row">
                          ...
                          <Grid item xs={1}><Typography style={{ color: "#2B2F3C", fontWeight: 400}}>:</Typography></Grid>
                          <Grid item xs={2}/>
                          <Grid item xs={5}><Typography style={{ color: "#2B2F3C", fontWeight: 600, textAlign: 'right'}}><TextRupiah value={total} /></Typography></Grid>
                        </Grid>
                      </Grid>
                    </Grid>
                  </Grid>
        ...
        <Grid item xs={5}>
          <Paper className={classes.rootPaper}>
            <Grid container direction='column' style={{ padding: 20, width: '100%' }}>
              <Grid item>
                <SmallInput
                  style={{ height: '23px' }}
