...
const TopComponent = ({ content }) => {
  ...
  const dataPenawaranHarga = [
    ...
    {
      label1: 'Tgl Request',
      value1: c.requestDate != null
        ? moment.unix(c.requestDate / 1000).format("DD-MM-YYYY")
        : "-",
    ...
    },
    {
      ...
      value2: c.address,
      label3: 'Lat Long',
      value3: <><div>Lat {coordArr[0]}</div><div>Long {coordArr[1]}</div></>,
    },
    {
      label1: 'Due Date',
      value1: c.dueDate != null
        ? moment.unix(c.dueDate / 1000).format("DD-MM-YYYY")
        : "-",
      label2: 'Area',
      value2: c.area,
      label3: 'Notes & Desc',
              ...
              <Grid container direction='row'>
                <Grid item xs={4}>
                  <Grid container direction='row'>
                    ...
                    <Grid item xs={7}>
                      <Typography style={{ fontWeight: 600 }}>{item.value1 || '-'}</Typography>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item xs={4}>
                  <Grid container direction='row'>
                    ...
                    <Grid item xs={7}>
                      <Typography style={{ fontWeight: 600, wordWrap: 'anywhere' }}>{item.value2 || '-'}</Typography>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item xs={4}>
                  <Grid container direction='row'>
                    ...
                    <Grid item xs={7}>
                      <Typography style={{ fontWeight: 600 }}>{item.label3 ? item.value3 || '-' : ''}</Typography>
                    </Grid>
                  </Grid>
                </Grid>
              </Grid>
