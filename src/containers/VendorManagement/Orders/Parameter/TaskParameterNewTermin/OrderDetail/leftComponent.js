...
function LeftComponent(props) {
  ...
  const [valueflmVendorRegion, setValueflmVendorRegion] = useState("");
  const [valueflmVendorSubRegion, setValueflmVendorSubRegion] = useState("");
              ...
              <Grid container direction="column">
                ...
                <Grid item style={{ marginTop: "13px" }}>
                  ...
                  <InputBordered
                    ...
                    onChange={(e) => {
                      handleChangeState(e.target.value, "atmId");
                    }}
                    value={data?.atmId}
                ...
                <Grid item style={{ marginTop: "13px" }}>
                  <InputBordered
                    ...
                    onChange={(e) => {
                      handleChangeState(e.target.value, "flmVendorRegion");
                    }}
                    value={data?.flmVendorRegion}
                ...
                <Grid item style={{ marginTop: "13px" }}>
                  <InputBordered
                    ...
                    onChange={(e) => {
                      handleChangeState(e.target.value, "flmVendorSubRegion");
                    }}
                    value={data?.flmVendorSubRegion}
                ...
                <Grid item>
                  <DatePicker
                    ...
                    onChange={(newDate) => {
                      ...
                      handleChangeState(valDate, "requestDatePsf");
                    }}
                    value={data.requestDatePsf? moment(data.requestDatePsf) : ""}
                    style={{
                      borderRadius: 6,
                      height: "40px",
                ...
                <Grid item>
                  <DatePicker
                    ...
                    onChange={(newDate) => {
                      ...
                      handleChangeState(valDate, "doneDatePsf");
                    }}
                    value={data.doneDatePsf? moment(data.doneDatePsf):""}
                    style={{
                      borderRadius: 6,
                      height: "40px",
                      border: "1px solid #BCC8E7",
