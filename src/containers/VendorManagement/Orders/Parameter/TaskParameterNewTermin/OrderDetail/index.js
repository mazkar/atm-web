...
import {
  doFetchDetailParamNewTermin,
  doSaveOrUpdateParamNewTermin,
} from "../../../../ApiServices";
...
const paramNewTermin = () => {
  ...
  useEffect(() => {
    ...
    doFetchDetailParamNewTermin(loadingHandler, id)
      .then((response) => {
        ...
        if (response) {
          ...
          const resDataLeft = {
            ...
            flmVendor: response.flmVendor,
            flmVendorRegion: response.flmVendorRegional,
            flmVendorSubRegion: response.flmVendorSubRegional,
            escrow: response.escrow,
            account: response.account,
            subaccount: response.subAccount,
            noPsf: response.noPsf,
            requestDatePsf: response.requestDatePsf > 0 ? response.requestDatePsf : null ,
            doneDatePsf: response.doneDatePsf > 0 ? response.doneDatePsf : null,
  ...
  const handleSave = async () => {
    ...
    const dataHit = {
      id,
      atmId: dataLeft.atmId,
      tellerId: dataLeft.tellerId,
      remotePort: dataLeft.remotePort,
      flmVendor: dataLeft.flmVendor,
      flmVendorRegion: dataLeft.flmVendorRegion,
      flmVendorSubRegion: dataLeft.flmVendorSubRegion,
      escrow: dataLeft.escrow,
      account: dataLeft.account,
      subaccount: dataLeft.subaccount,
      noPsf: dataLeft.noPsf,
      requestDatePsf: moment.unix(dataLeft.requestDatePsf / 1000),
      doneDatePsf: moment.unix(dataLeft.doneDatePsf / 1000),
    ...
    doSaveOrUpdateParamNewTermin(loadingHandler, dataHit)
      .then((res) => {
