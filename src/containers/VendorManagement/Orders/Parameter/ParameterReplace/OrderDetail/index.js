...
import {
  doFetchDetailParameter,
  doSaveOrUpdateParameter,
} from "../../../../ApiServices";
...
const createKebutuhan = () => {
  ...
  useEffect(() => {
    ...
    doFetchDetailParameter(loadingHandler, id)
      .then((response) => {
        ...
        if (response) {
          ...
          const resDataLeft = {
            ...
            requestDate: response.requestDate > 0 ? response.requestDate : null ,
            doneDate:response.doneDate > 0 ? response.doneDate : null ,
  ...
  const handleSave = async () => {
    ...
    const dataHit = {
      ...
      requestDate: moment
        .unix(dataLeft.requestDate / 1000)
        .format("DD-MM-YYYY"),
      doneDate: moment.unix(dataLeft.doneDate / 1000).format("DD-MM-YYYY"),
    ...
    doSaveOrUpdateParameter(loadingHandler, dataHit)
      .then((res) => {
