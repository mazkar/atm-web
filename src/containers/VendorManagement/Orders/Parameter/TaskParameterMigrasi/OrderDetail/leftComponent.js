...
function LeftComponent(props) {
  ...
  const [valueflmVendorSubRegional, setValueflmVendorSubRegional] =
    useState("");
        ...
        <div style={{ padding: 20 }}>
          ...
          <Grid container>
            <Grid item xs={6}>
              ...
              />
              <LableValue lable="Premises" value={dataResponse?.permises} />
              <LableValue lable="ATM ID Lama" value={dataResponse?.oldAtmId} />
              <LableValue
                lable="Tipe Mesin Lama"
                value={dataResponse?.oldMachineType}
              />
            </Grid>

            <Grid item xs={6}>
              <LableValue
                lable="Nama Lokasi Lama"
                value={dataResponse?.oldLocationName}
              />
              <LableValue lable="Kode GFMS" value={dataResponse?.gfmsCode} />
              <LableValue lable="PIC/Vendor" value={dataResponse?.picvendor} />
              <LableValue
                lable="Due Date"
                value={moment(dataResponse?.dueDate).format("DD/MM/YYYY")}
              />
              <LableValue
              ...
              <LableValue
                lable="Tipe Mesin"
                value={dataResponse?.machineType}
              />
              <LableValue lable="Denom" value={dataResponse?.denom} />
              <LableValue
                lable="Notes & Desc"
                value={dataResponse?.notesDesc}
              />
            </Grid>
          </Grid>
              ...
              <Grid container direction="column">
                ...
                <Grid item style={{ marginTop: "13px" }}>
                  <InputBordered
                    ...
                    value={data.newLocationName}
                    onChange={(e) => {
                      handleChangeState(e.target.value, "newLocationName");
                    }}
                ...
                <Grid item style={{ marginTop: "13px" }}>
                  <InputBordered
                    ...
                    value={dataResponse?.flmVendorRegional}
              ...
              <Grid container direction="column">
                ...
                <Grid item style={{ marginTop: "13px" }}>
                  <InputBordered
                    ...
                    value={dataResponse?.flmVendorSubRegional}
                ...
                <Grid item style={{ marginTop: "13px" }}>
                  <InputBordered
                    ...
                    onChange={(e) => {
                      ...
                      handleChangeState(e.target.value, "noRcf");
                    }}
                    value={dataResponse?.noRcf}
                ...
                <Grid item>
                  <DatePicker
                    ...
                    onChange={(newDate) => {
                      ...
                      handleChangeState(valDate, "psfRequestDate");
                    }}
                    value={data?.psfRequestDate? moment(data?.psfRequestDate) : ""}
                    style={{
                      borderRadius: 6,
                      height: "40px",
                ...
                <Grid item>
                  <DatePicker
                    ...
                    onChange={(newDate) => {
                      ...
                      handleChangeState(valDate, "psfDoneDate");
                    }}
                    value={data?.psfDoneDate? moment(data?.psfDoneDate): ""}
                    style={{
                      borderRadius: 6,
                      height: "40px",
                      border: "1px solid #BCC8E7",
          ...
          <Grid container>
            <Grid item xs={6}>
              ...
              <LableValue
                ...
                value={dataResponse?.branchInitial}
              />
              <LableValue lable="Kode GFMS" value={dataResponse?.gfmsCode} />
              <LableValue
                lable="Nama Req"
              ...
              <LableValue
                lable="Nama Branch"
                value={dataResponse?.nameBranchRequester}
              />
              <LableValue
                lable="No Telp Req"
              ...
              <LableValue
                ...
                value={dataResponse?.requesterEmail}
              />
              <LableValue
                lable="Alamat Branch"
            ...
            <Grid item xs={6}>
              ...
              <LableValue
                ...
                value={dataResponse?.arroundAtmBank}
              />
              <LableValue lable="Denom" value={dataResponse?.denom} />
