...
const TopComponent = (props) => {
  ...
  const { setData, handleMessage, onMessageEnter, } = props;
  ...
  const fieldInformasiPenawaran = [
    {
      ...
      value2: c.jenisPekerjaan,
    },
    {
      label1: "Tgl Request",
      value1: moment(c.requestDate).format("DD/MM/YYYY"),
      label2: "PIC / Vendor",
      value2: c.namaVendor,
    },
    {
    ...
    {
      label1: "Tipe Mesin",
      value1: c.machineType,
      label2: "Area",
      value2: c.area,
    },
    {
      label1: "Tgl Pemasangan",
      value1: moment(c.dueDate).format("DD/MM/YYYY"),
      label2: "City",
      value2: c.city,
    },
    {
                    ...
                    <Grid item xs={5}>
                      <Grid container direction="row">
                        ...
                        <Grid item xs={6} justify="flex-start">
                          <Typography
                            style={{ fontWeight: 600, color: "#2B2F3C" }}
                          >
                            {data.value2}
                          </Typography>
                        </Grid>
            ...
            >
              ...
              <Grid item>
                <Box className={classes.boxStyle}>
                  ...
                  >
                    {setData?.baseComment?.length > 0 &&
                      setData?.baseComment?.map((data) => (
                        <ChatHistory
                          name={data.userName}
                          comment={data.message}
                          date={moment(data.createdDate).format('DD/MM/YYYY | HH:mm')}
                          showName
                        />
                      ))}
                  </div>
