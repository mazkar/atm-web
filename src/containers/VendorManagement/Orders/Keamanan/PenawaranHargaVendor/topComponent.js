...
const TopComponent = ({ content, messageHandler, onMessageEnter }) => {
  ...
  const fieldInformasiPenawaran = [
    ...
    {
      label1: "Jenis Pekerjaan",
      value1: c.jenisPekerjaan,
      label2: "Alamat",
      value2: c.address,
    },
    { label1: "Due Date", value1: c.dueDate, label2: "Area", value2: c.area },
    { label1: "ID Mesin", value1: c.idMachine, label2: "City", value2: c.city },
    {
      label1: "Notes & Desc",
      value1: c.noteDesc,
      label2: "Lat Long",
  ...
  const chatHistoryData = c?.listComment
    ?.map((val) => ({
      name: val.userName,
      comment: val.message,
