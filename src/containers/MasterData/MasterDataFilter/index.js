...
import { AdvancedSmallInput } from '../../../components/chky/ChkyInputSmall';
...
const MasterDataFilter = (props) => {
  ...
  const [atmIdOrLocationName, setAtmIdOrLocationName] = useState('')
            ...
            <Grid container alignItems="center">
              ...
              <Grid item>
                ...
                <div className={classes.col}>
                  ...
                  <div>
                    <FormControl className={classes.select} style={{width:'200px'}}>
                      <AdvancedSmallInput stateVar={atmIdOrLocationName} stateModifier={setAtmIdOrLocationName} />
                    </FormControl>
                  </div>
                </div>
              </Grid>
...
MasterDataFilter.propTypes = {
  onFilterSubmit: PropTypes.func,
};

MasterDataFilter.defaultProps = {
