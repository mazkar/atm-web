...
const ModalPopUpUploadDwh = ({ isOpen, onClose, onSuccesUpload }) => {
  const {
    root,
    modal,
    paper,
  ...
  const handleSubmit = (event) => {
    ...
    axios({
      method: "post",
      url: `${constants.MONITORING_SERVICE}/uploadMasterMonitoring`,
      data: formData,
      headers: {
...
ModalPopUpUploadDwh.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccesUpload: PropTypes.func.isRequired,
};

export default ModalPopUpUploadDwh;
