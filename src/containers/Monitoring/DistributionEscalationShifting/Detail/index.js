...
import DetailTabTicketDistribution from "./DetailTabTicket";
...
function DetailTicketDistribution() {
  ...
  return (
    <Box className={classes.root}>
      <Grid container>
        <Grid item xs={12}>
          <Button
            onClick={() => history.push("/monitoring/ticket-distribution")}
          >
            <BackIcon />
...
export default DetailTicketDistribution;
