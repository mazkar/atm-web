...
import { Box, Grid, Typography, Dialog, Avatar,Button, IconButton} from "@material-ui/core";
...
const viewSurat = ({
  ...
  const { paper, boxStyle, avatar,secondaryButton,primaryButton } = useStyles();
  ...
  //const history = useHistory();
  const {userId,userFullName,userRoleName,userVendorId}=useContext(RootContext)
  const {id}=useParams()
  ...
  const handleSubmitSurat=async()=>{
    ...
    const dataSave = {
      ...
      logoPerusahaan: photoLogoCompany.path ? photoLogoCompany.path : dataAll.logoPicture,
      nomerSurat: dataAll.nomerSurat,
      tempat: dataAll.tempat,
      tanggal: dataSurat?.tangalSurat,
      hal: dataAll.hal,
      ttd: photoTTDCompany.path ? photoTTDCompany.path : dataAll.ttdPicture,
      nama: dataAll.nama,
                  ...
                  {dataAll.logoPicture ? (
                    <div style={{ position: "relative", width: 260 }}>
                      ...
                      <IconButton
                        ...
                        onClick={() => {
                          handleChangeState(null, "logoPicture");
                        }}
                      >
                    ...
                    <ImageSelector
                      ...
                      onChange={(e) => setPhotoLogo(e.target.files[0])}
                      selectedImage={photoLogo}
                      onDelete={() => setPhotoLogo("")}
                    />
                  )}
                </div>
              ) : (
                <div>
                  {dataAll.logoPicture ? (
                    ...
                    <>
                      {photoLogo !== "" ? (
                        <img
                          src={URL.createObjectURL(photoLogo)}
                          style={{ borderRadius: 10, width: 101, height: 80 }}
                          alt="img"
                        />
                      ) : (
              ...
              >
                <Grid item xs={5}>
                  <InputBordered
                    ...
                    onChange={(e) =>
                      handleChangeState(e.target.value, "nomerSurat")
                    }
                ...
                <Grid item xs={2}>
                  <InputBordered
                    ...
                    onChange={(e) =>
                      handleChangeState(e.target.value, "tempat")
                    }
                    disabled={typeView === "view"}
                  />
                </Grid>
              ...
              <Grid container direction="row" spacing={2}>
                ...
                <Grid item xs={9}>
                  ...
                  <InputBordered
                    ...
                    value={dataAll.hal}
                    onChange={(e) => handleChangeState(e.target.value, "hal")}
                    disabled={typeView === "view"}
                  />
                </Grid>
              </Grid>
                  ...
                  {dataAll.ttdPicture ? (
                    <div style={{ position: "relative", width: 260 }}>
                      ...
                      <IconButton
                        ...
                        onClick={() => {
                          handleChangeState(null, "ttdPicture");
                        }}
                      >
                        <DeleteIcon fontSize="small" />
                      </IconButton>
                    ...
                    <ImageSelectLogo
                      ...
                      largerMinHeight={80}
                      title="TTD"
                      onChange={(e) => setPhotoTTD(e.target.files[0])}
                      selectedImage={photoTTD}
                      onDelete={() => setPhotoTTD("")}
                    />
                  )}
                </div>
              ) : (
                <div>
                  {dataAll.ttdPicture ? (
                    ...
                    <>
                      {photoTTD !== "" ? (
                        <img
                          src={URL.createObjectURL(photoTTD)}
                          style={{ borderRadius: 10, width: 101, height: 80 }}
                          alt="img"
                        />
                      ) : (
              ...
              <div>
                ...
                <Grid item style={{ marginTop: "30px" }}>
                  <InputBordered
                    ...
                    placeholder="Nama"
                    value={dataAll.nama}
                    onChange={(e) => handleChangeState(e.target.value, "nama")}
                  />
                </Grid>
                <Grid item style={{ marginTop: "30px" }}>
                  <InputBordered
                    style={{ width: "177px", height: "24px" }}
                    placeholder="Jabatan"
                    value={dataAll.jabatan}
                    onChange={(e) =>
                      handleChangeState(e.target.value, "jabatan")
                    }
                  />
                </Grid>
              </div>
