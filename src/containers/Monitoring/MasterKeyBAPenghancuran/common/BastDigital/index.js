        ...
        const vendorDetailsArr = (val) => {
          ...
          if (val.length > 0) {
            const newArr = [
              {
                check: "checkedCR",
                phone: val.find((obj) => obj.key === "CR Telephone Number")
                  ?.value,
              ...
              {
                check: "checkedFLM",
                phone: val.find((obj) => obj.key === "FLM Telephone Number")
                  ?.value,
              ...
              {
                check: "checkedSLM",
                phone: val.find((obj) => obj.key === "SLM Telephone Number")
                  ?.value,
              ...
              },
              {
                check: "checkedSecurity",
                phone: val.find(
                  (obj) => obj.key === "Security Telephone Number"
                )?.value,
              ...
              {
                check: "checkedVendorJaringan",
                phone: val.find((obj) => obj.key === "Jarkom Telephone Number")
                  ?.value,
              ...
              },
              {
                check: "checkedVendorMaintenance",
                phone: val.find(
                  (obj) => obj.key === "Maintenance Telephone Number"
                )?.value,
              ...
              {
                check: "checkedVendorMediaPromosi",
                phone: val.find((obj) => obj.key === "Promosi Telephone Number")
                  ?.value,
              ...
              {
                check: "checkedVendorSurvey",
                phone: val.find((obj) => obj.key === "Survey Telephone Number")
                  ?.value,
              ...
              {
                check: "checkedOthers",
                phone: val.find((obj) => obj.key === "Other Telephone Number")
                  ?.value,
          ...
          if (response.vendorDetails !== null) {
            if (response.vendorDetails.length > 0) {
              const dataCheckedNew = {
                checkedFLM: response.vendorDetails.find(
                  (obj) => obj.key === "FLM Name"
                )
                  ? response.vendorDetails.find((obj) => obj.key === "FLM Name")
                      ?.value !== ""
                  : false,
                checkedSLM: response.vendorDetails.find(
                  (obj) => obj.key === "SLM Name"
                )
                  ? response.vendorDetails.find((obj) => obj.key === "SLM Name")
                      ?.value !== ""
                  : false,
                checkedCR: response.vendorDetails.find(
                  (obj) => obj.key === "CR Name"
                )
                  ? response.vendorDetails.find((obj) => obj.key === "CR Name")
                      ?.value !== ""
                  : false,
                checkedSecurity: response.vendorDetails.find(
                  (obj) => obj.key === "Security Name"
                )
                  ? response.vendorDetails.find(
                      (obj) => obj.key === "Security Name"
                    )?.value !== ""
                  : false,
                checkedVendorJaringan: response.vendorDetails.find(
                  (obj) => obj.key === "Jarkom Name"
                )
                  ? response.vendorDetails.find(
                      (obj) => obj.key === "Jarkom Name"
                    )?.value !== ""
                  : false,
                checkedVendorMaintenance: response.vendorDetails.find(
                  (obj) => obj.key === "Maintenance Name"
                )
                  ? response.vendorDetails.find(
                      (obj) => obj.key === "Maintenance Name"
                    )?.value !== ""
                  : false,
                checkedVendorMediaPromosi: response.vendorDetails.find(
                  (obj) => obj.key === "Promosi Name"
                )
                  ? response.vendorDetails.find(
                      (obj) => obj.key === "Promosi Name"
                    )?.value !== ""
                  : false,
                checkedVendorSurvey: response.vendorDetails.find(
                  (obj) => obj.key === "Survey Name"
                )
                  ? response.vendorDetails.find(
                      (obj) => obj.key === "Survey Name"
                    )?.value !== ""
                  : false,
                checkedOthers: response.vendorDetails.find(
                  (obj) => obj.key === "Other Name"
                )
                  ? response.vendorDetails.find(
                      (obj) => obj.key === "Other Name"
                    )?.value !== ""
  ...
  const onSubmitNewBAST = async () => {
    ...
    checkedArr.map((item) => {
      ...
      const newObjName = {
        key: `${key} Name`,
        value:
          dataBast.vendorDetails.find((values) => values.check === item).name ||
          "",
      };
      const newObjPhone = {
        key: `${key} Telephone Number`,
        value:
          dataBast.vendorDetails.find((values) => values.check === item)
            .phone || "",
      };
                ...
                >
                  <Grid item xs={6}>
                    <Grid container direction="column" spacing={2}>
                      <Grid item>
                        <Typography>No. /SRT/ATM-BG/VIII/2020</Typography>
                        <Typography>Jakarta Barat, 18 Agustus 2020</Typography>
                      </Grid>
                      <Grid item>
                        <Typography>Kepada Yth :</Typography>
                        <Typography>Bapak/Ibu Administrator</Typography>
                        <Typography>
                          Pemilik Pengelola Lokasi Administrator
                        </Typography>
                      </Grid>
                      <Grid item>
                        <Typography>
                      ...
                      <Grid item>
                        <Grid container direction="row">
                          <Grid item xs={6}>
                            ...
                            <Typography>HJK-26262BT-987-LS98</Typography>
                          </Grid>
                          <Grid item xs={6}>
                            <Typography style={{ fontWeight: 600 }}>
                              Longitude :
                      ...
                      <Grid item>
                        <Grid container direction="row">
                          <Grid item xs={6}>
                            ...
                            <Typography>Jakarta Barat</Typography>
                          </Grid>
                          <Grid item xs={6}>
                            <Typography style={{ fontWeight: 600 }}>
                              Kota :
                      ...
                      <Grid item>
                        <Grid container direction="row">
                          <Grid item>
                            ...
                            <Typography>Jalan kenangan</Typography>
                          </Grid>
                        </Grid>
                      </Grid>
                    </Grid>
