...
const SummaryDonutChart = (props) => {
  const classes = useStyles();
  const {dataChartDurasi,upTime,downTime} = props
  const tplTooltip =
  ...
  return (
    ...
    >
      <>
        ...
        >
          Presentasi Uptime & Downtime (Durasi)
        </Typography>

        <Grid container spacing={2} alignItems="center">
          <Grid item xs={6} md={6}>
            <Chart data={dataChartDurasi} height={180} width={180} autoFit>
...
SummaryDonutChart.propTypes = {
  dataChartDurasi: PropTypes.object.isRequired,
