...
const ModalPopUpUpload = ({ isOpen, onClose, onSuccesUpload }) => {
  const {
    root,
    modal,
    paper,
  ...
  const handleSubmit = (event) => {
    ...
    axios({
      method: "post",
      url: `${process.env.REACT_APP_API_INFORMATION_MONITORING}/uploadResponsCodeAnalizer`,
      data: formData,
      headers: {
...
ModalPopUpUpload.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccesUpload: PropTypes.func.isRequired,
};

export default ModalPopUpUpload;
