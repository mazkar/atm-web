...
const ApprovalTabInfo = (props) => {
  ...
  function showDataBiayaSewa(keyName, index) {
    const lengthDetailRent = data.detailRent.length;
    ...
    if (keyName === "yearlyTelephoneRentCost") {
      if (!lengthDetailRent) {
        ...
        return idrCurrencyFormat(
          data.detailRent[index].yearlyTelephoneRentCost
        );
      }
    }
              ...
              <Table size="small">
                <TableRow className={classes.tableRow}>
                  ...
                  <TableCell className={classes.tableCell}>
                    ...
                    {isEmpty(data)
                      ? "-"
                      : setStringValue(data.informasiApproval.openingType)}{" "}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell width="40%" className={classes.tableCell}>
                ...
                <TableRow className={classes.tableRow}>
                  ...
                  <TableCell className={classes.tableCell}>
                    ...
                    {isEmpty(data)
                      ? "-"
                      : setStringValue(data.informasiApproval.locationPicName)}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell width="40%" className={classes.tableCell}>
              ...
              <Table size="small">
                ...
                <TableRow className={classes.tableRow}>
                  ...
                  <TableCell className={classes.tableCell}>
                    ...
                    {isEmpty(data)
                      ? "-"
                      : setStringValue(data.informasiApproval.locationCategory)}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell width="40%" className={classes.tableCell}>
                  ...
                  <TableCell className={classes.tableCell}>
                    ...
                    {isEmpty(data)
                      ? "-"
                      : data.informasiApproval.workingHour ? `${setStringValue(data.informasiApproval.workingHour)} Jam` : "-"}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell width="40%" className={classes.tableCell}>
                    ...
                    <Typography style={{ fontSize: 12, fontWeight: 400 }}>
                      {isEmpty(data) ? (
                        ...
                        <span>
                          ...
                          -{" "}
                          {timestamptToDate(data.informasiApproval.endRentDate)}
                        </span>
                      )}
                    </Typography>
                  </TableCell>
              ...
              <Table size="small">
                ...
                <TableRow className={classes.tableRow}>
                  ...
                  <TableCell className={classes.tableCell}>
                    ...
                    {isEmpty(data)
                      ? "-"
                      : showDataBiayaSewa("yearlyTelephoneRentCost", yearValue)}
                  </TableCell>
                </TableRow>
                <TableRow className={classes.tableRow}>
                  <TableCell width="40%" className={classes.tableCell}>
                ...
                <Table size="small">
                  <TableRow className={classes.tableRow}>
                    ...
                    <TableCell className={classes.tableCell}>
                      ...
                      {isEmpty(data)
                        ? "-"
                        : idrCurrencyFormat(data.informasiApproval.minOffering)}
                    </TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>
                  ...
                  <TableRow className={classes.tableRow}>
                    ...
                    <TableCell className={classes.tableCell}>
                      ...
                      {isEmpty(data)
                        ? "-"
                        : idrCurrencyFormat(data.informasiApproval.maxOffering)}
                    </TableCell>
                  </TableRow>
                </Table>
              </Table>
