...
let photoTampakMukaNoR = null;
let photoPosisiNeonNoR = null;
let photoPosisiAntenaNoR = null;
let photoLayoutNoR = null;
...
const tipeLokasiNoR = "-";
const boothTypeNoR = "-";
const buildingLargeNoR = "";
let aksesUmumNoR = "Tidak";
let aksesUmumTabNoR = 1;
const mediaPromosiNoR = [];
let atmBankLainNoR = [];
let valueAtmBankLainNoR = [];
const noteAksesUmumNoR = "";
const startTimeNoR = "";
const startTimeNoRCheck = "";
const endTimeNoR = "";
const endTimeNoRCheck = "";
const denomNoR = "-";
const acNoR = "- Include / Exclude -";
const kebersihanNoR = "- Include / Exclude -";
const jenisKomNoR = "- Pilih Jenis Komunikasi -";
const noteMediaPromNoR = "";
let promotionMedia = {
...
const LocationDetailAtm = (props) => {
  ...
  const { onChangeData, errorForm, dataValue, dataFetched } = props;
  ...
  const [buildingLarge, setBuildingLarge] = useState("");
  const [aksesUmum, setAksesUmum] = useState("Tidak");
  const [mediaPromosi, setMediaPromosi] = useState([]);
  const [atmBankLain, setATMBankLain] = useState([]);
  const [noteAksesUmum, setNoteAksesUmum] = useState("");
  const [startTime, setStartTime] = useState("");
  const [endTime, setEndTime] = useState("");
  const [denom, setDenom] = useState("");
  const [ac, setAc] = useState("");
  const [kebersihan, setKebersihan] = useState("");
  const [jenisKom, setJenisKom] = useState("");
  const [noteMediaProm, setNoteMediaProm] = useState("");
  ...
  const handleMediaPromosi = (e) => {
    newHandleDataDetailATM(e, "mediaPromotion");
  };
  const handleAtmBankLain = (e, newValue) => {
  ...
  const handleKebersihan = (e) => {
    newHandleDataDetailATM(e, "cleanType");
  };
  const handleJenisKom = (e) => {
    newHandleDataDetailATM(e, "commType");
  };
  const handleNoteMediaProm = (e) => {
  ...
  const [dataImage3, setDataImage3] = useState(null);
  const [dataImage4, setDataImage4] = useState(null);
  const [dataImage5, setDataImage5] = useState(null);

  const [imageMachinePosition, setMachinePosition] = useState(null);
  const [imageFront, setImageFront] = useState(null);
  const [imageNeonPosition, setNeonPosition] = useState(null);
  const [imageAntenaPosition, setAntenaPosition] = useState(null);
  ...
  // console.log("??? +++ promotionMedia", promotionMedia);
    ...
    for (const propt in promotionMedia) {
  ...
  return (
    <AccordionContainer title="Detail ATM" defaultExpanded>
