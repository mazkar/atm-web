...
const ModalUploadError = ({ isOpen, onClose, onLeave, uploadTitle, message }) => {
  const {
    modal,
    paper,
    closeIcon,
        ...
        >
          <Grid item>
            <Typography variant="h4" component="h4">
              {uploadTitle !== undefined ? uploadTitle : "Upload RBB Failed!"}
            </Typography>
          </Grid>
...
ModalUploadError.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onLeave: PropTypes.func.isRequired,
};

export default ModalUploadError;
