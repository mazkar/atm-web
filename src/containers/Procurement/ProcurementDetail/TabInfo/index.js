...
const dataAtmDummy = {};
const dataSelectYear = [{"name":"Tahun Ke 1", "value":0},{"name":"Tahun Ke 2", "value":1},{"name":"Tahun Ke 3", "value":2},{"name":"Tahun Ke 4", "value":3},{"name":"Tahun Ke 5", "value":4}];
      ...
      <Grid container spacing={2} alignItems="center">
        <Grid item sm={3}>
          <Typography style={{ fontSize: 28, }}>
            ATM {isEmpty(data) ? '' : (data.informasiApproval.locationId || data.informasiApproval.atmId)}
          </Typography>
          </Grid>
        <Grid item sm={7}>
          <Tabs
        ...
        <Grid item sm={2}>
          <Grid container justify="space-between">
            <Grid item />
            <Grid item>
              {isEmpty(data) ? '-' : renderType(data.informasiApproval.openingType) }
            </Grid>
          </Grid>
        </Grid>
      </Grid>
              ...
              <Grid item className={classes.gridContent} xs={5}>
                <Table size="small">
                  <TableRow className={classes.tableRow}>
                    ...
                    <TableCell className={classes.tableCell}>: {isEmpty(data) ? '-' :setStringValue(data.informasiApproval.openingType)} </TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Nama Lokasi / ID</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.newLocation)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Alamat</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.address)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Initial Cabang</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.branchInitial)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Code GFMS</TableCell>
                    <TableCell className={classes.tableCell}>: {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.codeGFMS)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>PIC Cabang</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.branchPicName)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Nama PIC Lokasi</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.ownerPicName)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Nama Penanda Tangan LOO / MOU</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.locationPicName)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Populasi ATM</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.countAtm)}</TableCell>
                  </TableRow>
                </Table>
              </Grid>
              <Grid item className={classes.gridContent} xs={5}>
                <Table size="small">
                  <TableRow className={classes.tableRow}>
                    ...
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.categoryType)}</TableCell>
                  </TableRow>
                  {/* <TableRow className={classes.tableRow}>
                ...
                <TableRow className={classes.tableRow}>
                  ...
                  <TableRow className={classes.tableRow}>
                    ...
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.locationCategory)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Aksesibilitas/Operasional</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : data.informasiApproval?.workingHour ? `${setStringValue(data.informasiApproval.workingHour)} Jam` : "-"}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Akses Umum/Publik</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.publicAccessibility)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Luas Area ATM</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.buildingLarge)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Jumlah ATM Bank Lain</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.aroundAtmCount)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Tipe ATM</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.typeAtm)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Ruang ATM</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.boothType)}</TableCell>
                  </TableRow>
                  <TableRow className={classes.tableRow}>
                    <TableCell width="40%" className={classes.tableCell}>Komunikasi</TableCell>
                    <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : setStringValue(data.informasiApproval.commType)}</TableCell>
                  </TableRow>
                </Table>
              </Grid>
            </Grid>
              ...
              <Grid item xs={12}>
                <Box className={classes.mapContainer}>
                  <Map
                    ...
                    center={isEmpty(data) ? [-6.229728,106.6894312] : locationMarker(data.informasiApproval.latitude, data.informasiApproval.longitude)}
                    zoom={80}
                  ...
                  >
                    ...
                    <Marker 
                      position={isEmpty(data) ? [-6.229728,106.6894312] : locationMarker(data.informasiApproval.latitude, data.informasiApproval.longitude)}
                    />
                    ...
                    <TableCell className={classes.tableCell}>
                      <div style={{width: 135}}>
                        <ChkySelectInput 
                          ...
                          selectOptionData={isEmpty(data)? [{"name":"Tahun Ke 1", "value":0}] :  data.detailRent.length < 1 ? [{"name":"Tahun Ke 1", "value":0}] :  dataSelectYear.slice(0, data.detailRent.length)}
                        />
                      </div>
                    </TableCell>
                    <TableCell className={classes.tableCell}>
                      ...
                      <Typography style={{fontSize: 12, fontWeight: 400}}>{isEmpty(data) ? '-' : 
                        (<span>{timestamptToDate(data.informasiApproval.startRentDate)} - {timestamptToDate(data.informasiApproval.endRentDate)}</span>) 
                      }</Typography>
                    </TableCell>
                  </TableRow>
                </Table>
                ...
                <Table size="small">
                  ...
                  <Table size="small">
                    <TableRow className={classes.tableRow}>
                      ...
                      <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : idrCurrencyFormat(data.informasiApproval.minOffering)}</TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width="40%" className={classes.tableCell}>Nilai Tengah</TableCell>
                      <TableCell className={classes.tableCell}>: {isEmpty(data) ? '-' : idrCurrencyFormat(data.informasiApproval.averageOffering)}</TableCell>
                    </TableRow>
                    <TableRow className={classes.tableRow}>
                      <TableCell width="40%" className={classes.tableCell}>Nilai Tertinggi</TableCell>
                      <TableCell className={classes.tableCell}>:  {isEmpty(data) ? '-' : idrCurrencyFormat(data.informasiApproval.maxOffering)}</TableCell>
                    </TableRow>
                  </Table>
                </Table>
              </Grid>
