...
const dataTaskMesin = [
  ...
  {
    id: 2,
    value: "No Aset Gudang",
    nameId: "No Aset Gudang",
    nameEn: "No Aset Gudang",
  },
  {
    id: 3,
    value: "Not Request (-)",
                ...
                <Grid container direction="column">
                  ...
                  <Grid item style={{ marginTop: "5px", width: "100%" }}>
                    ...
                    >
                      ...
                      <Select
                        className={"CommonSelect__select"}
                        style={{ width: "96%" }}
