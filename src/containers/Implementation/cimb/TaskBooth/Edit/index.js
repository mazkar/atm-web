...
import { doFetchDetailBooth, doCreateUpdateCardBooth, doUploadDocument, doUploadPhoto, doSaveComment } from '../../../ApiServiceImplementation';
    ...
    doFetchDetailBooth(loadingHandler, {boothId: taskId})
      .then((response) => {
        ...
        const resDataLeft = {
          ...
          boothType: response.implementationInfo.boothType,
          dimensi: response.implementationInfo.dimensi,
          totalBiaya: response.implementationInfo.totalBiaya,
