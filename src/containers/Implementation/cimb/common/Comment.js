      ...
      <div className={classes.root}>
          <div className={classes.numbering}>
            ...
            <Grid container direction='row'>
                <Typography style={{ fontSize: 12, fontWeight: 600, fontFamily: 'Barlow', marginRight: 10}}>
                    {name || '-'}
                </Typography>
                <Typography style={{ fontSize: 12, fontWeight: 400, fontFamily: 'Barlow', color: '#BCC8E7'}}>
                    {date || '-'}
                </Typography>
            </Grid>
            <Typography style={{ fontSize: 12, fontWeight: 400, fontFamily: 'Barlow'}}>
                {comment}
            </Typography>
            </div>
          </div>
