...
import { doFetchDeleteParameterNewTermin, doFetchDetailParameterNewTermin } from '../../../ApiServiceImplementation';
...
function Create(props) {
  ...
  function handleDelete() {
    doFetchDeleteParameterNewTermin(loadingHandler, {parameterId: taskId})
      .then((response) => {
    ...
    doFetchDetailParameterNewTermin(loadingHandler, {parameterId: taskId})
      .then((response) => {
        ...
        const resDataLeft = {
          ...
          requestType: response.implementationInfo.requestType !== null ? response.implementationInfo.requestType : "-",
          denom: response.implementationInfo.denom !== null ? response.implementationInfo.denom : "-",
          kodeGfms: response.implementationInfo.codeGfms !== null ? response.implementationInfo.codeGfms : "-",
          typePremises: response.implementationInfo.locationMode !== null ? response.implementationInfo.locationMode : "-",
          premises: response.implementationInfo.modelTeam !== null ? response.implementationInfo.modelTeam : "-",
          noRfc: response.implementationInfo.noRfc !== null ? response.implementationInfo.noRfc : "-",
          tglPsfSelesai: response.implementationInfo.psfDoneDate !== null ? moment.unix(response.implementationInfo.psfDoneDate/1000).format("YYYY-MM-DD") : "-",
          noPsf: response.implementationInfo.noPsf !== null ? response.implementationInfo.noPsf : "-",
          ...
          <Grid container spacing={2} direction="row" justify="space-between">
            ...
            <Grid item>
              <ChkyButtons
                ...
                onClick={() => {
                  history.push(`/implementation/task/parameter/${taskId}/edit?implementationId=${implementationId}`);
                }}
