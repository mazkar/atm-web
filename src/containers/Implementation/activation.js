...
const Overview = () => {
  ...
  const imageData=[{src: sudirmanAtmImage},{src: sudirmanAtmImage},{src: sudirmanAtmImage},{src: sudirmanAtmImage}];
  const dataNego=[
    {title: "ATM Instalation", price: "", date:"20 July 2020", status:"Waiting", position:""},
    {title: "Input Data", price: "", date:"20 July 2020", status:"Waiting", position:""},
    {title: "Activation", price: "", date:"20 July 2020", status:"Waiting", position:"end"},
  ];
    ...
    <div className="content_container" style={{paddingBottom:65}}>
      <Paper elevation={3} className={classes.root}>
        <Grid container spacing={2} >
          <Grid item xs={12} sm={7}>
            ...
            <Grid container spacing={3} style={{marginTop:10}}>
              <Grid item xs={4}>
                <InputLabel htmlFor="inputVendor" style={{fontWeight: 'bold', fontSize: 13, color: '#000', marginBottom: -15}}>
                    Vendor Name :
                </InputLabel>
                <InputCustom placeholder="Vendor Name" id="inputVendor" />
              </Grid>
              <Grid item xs={4}>
                <InputLabel htmlFor="inputType" style={{fontWeight: 'bold', fontSize: 13, color: '#000', marginBottom: -15}}>
                    ATM Type :
                </InputLabel>
                <InputCustom placeholder="ATM Type" id="inputType" />
              </Grid>
              <Grid item xs={4}>
                <InputLabel htmlFor="inputAtmId" style={{fontWeight: 'bold', fontSize: 13, color: '#000', marginBottom: -15}}>
                    ATM ID :
                </InputLabel>
                <InputCustom placeholder="ATM Id" id="inputAtmId" />
              </Grid>
            </Grid>
          ...
          <Grid item xs={12} sm={5} style={{marginTop:10, marginBottom:10}}>
            <Typography style={{fontSize:24, paddingLeft:40}}>Activation Process</Typography>
            <div>
        ...
        <Grid container spacing={3} justify="space-between" style={{marginTop:10}}>
          ...
          <Grid item xs={6} className={classes.gridButton} style={{textAlign:'right'}}>
            <Button color="redHard">Process</Button>
          </Grid>
        </Grid>
      </Paper>
