...
const ParameterDevops = () => {
  ...
  const dataRequest = [
    { 
      ...
      flmRegion: 'Jakarta Barat', flmSubRegion: '1200019271', update: actionUpdate 
    },
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', alamat: 'Jl. Gatot Subroto, No.33', mesin: 'ATM', 
      branch: '120192', area: 'Jakarta', kota: 'Jakarta', flm: 'Nama FLM Vendor', 
  ...
  const dataDone = [
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', alamat: 'Jl. Gatot Subroto, No.33', mesin: 'ATM', 
      branch: '120192', area: 'Jakarta', kota: 'Jakarta', flm: 'Nama FLM Vendor', 
      flmRegion: 'Jakarta Pusat', flmSubRegion: '1200019271', update: actionUpdate 
    },
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', alamat: 'Jl. Gatot Subroto, No.33', mesin: 'ATM', 
      branch: '120192', area: 'Jakarta', kota: 'Jakarta', flm: 'Nama FLM Vendor', 
...
export default ParameterDevops;