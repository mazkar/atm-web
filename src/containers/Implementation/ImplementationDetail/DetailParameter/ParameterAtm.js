...
const ParameterAtm = () => {
  ...
  // TABLE //
  const valueType = 
  [ 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'modal' ];
  ...
  const dataRequest = [
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', mesin: 'ATM', branch: '5523', 
      konven: '120129812', idMesin: '1200019271', tellerId: '1200092172', 
      remote: '120.880.029.110', update: actionUpdate 
    },
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', mesin: 'CDM', branch: '5523', 
      konven: '120129812', idMesin: '1200019271', tellerId: '1200092172', 
      remote: '120.880.029.110', update: actionUpdate 
    },
  ];
