...
const ParameterAtm = () => {
  ...
  // TABLE //
  const valueType = 
  [ 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'modal' ];
  ...
  const dataRequest = [
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', alamat: 'Jl.Gatot Subroto, No.56...', branch: '120009271', 
      idMesin: '1200019271', area: 'Jakarta', vsat: 'Bisa', provider: 'Telkomsel', 
      ipMesin: '190.180.000.120', ipGw: '210.201.202.222', subnet: '210.201.202.222', update: actionUpdate 
    },
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', alamat: 'Jl.Gatot Subroto, No.56...', branch: '120009271', 
      idMesin: '1200019271', area: 'Jakarta', vsat: 'Bisa', provider: 'Telkomsel', 
  ...
  const dataDone = [
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', alamat: 'Jl.Pemukti, No.22...', branch: '120009271', 
      idMesin: '1200019271', area: 'Jakarta', vsat: 'Bisa', provider: 'Telkomsel', 
      ipMesin: '190.180.000.120', ipGw: '210.201.202.222', subnet: '210.201.202.222', update: actionUpdate 
    },
    { 
