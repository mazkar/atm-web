...
const ParameterFinance = () => {
  ...
  // TABLE //
  const valueType = 
  [ 'string', 'string', 'string', 'string', 'string', 'string', 'modal' ];
  ...
  const dataRequest = [
    { 
      ...
      idMesin: '1200019271', tellerId: '1200092172', 
      account: 'Sub Account', update: actionUpdate 
    },
    { 
      namaLokasi: 'CIMBN.JKT.Meruya.SPBU', mesin: 'ATM', branch: '5523', 
      idMesin: '1200019271', tellerId: '1200092172', 
...
export default ParameterFinance;