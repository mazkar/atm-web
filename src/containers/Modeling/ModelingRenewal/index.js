...
import { ChkyDownloadButton, ChkyFilterRenewalForecast, ChkyTablePagination, ChkyUploadMedicalButton } from '../../../components/chky';
  ...
  return (
    <div className={classes.root}>
      <Grid container justify="space-between" className={classes.titleContainer} alignItems="center">
        <Grid item>
          <Typography  className={classes.title}>Renewal</Typography>
        </Grid>
        <Grid item>
          <ChkyDownloadButton
            style={{ marginRight: 5 }}
      ...
      <div className={classes.container}>
        <div className={classes.filterContainer}>
          <ChkyFilterRenewalForecast onFilterSubmit={handleFilter}/>
        </div>
        <div item className={classes.tableContent}>
          ...
          <ChkyTablePagination
            data={[]}
            style={{'& .MuiPaper-elevation1': {boxShadow: 'none',},}}
            fields={currentTitle}
...
export default withRouter(
  connect(mapStateToProps)(withTranslation('translations')(ModelingRenewal))
);