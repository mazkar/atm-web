...
const AddFileDocProject = () => {
  ...
  const onClosePopUp = () => {
    history.push(
      `/file-management/configuration/detail-doc-project/${folderId}`
    );
  };
  ...
  useEffect(() => {
    if (pathCategory === "edit-file") {
      dogetDetailAllFile(loaderHandler, { id: fileId, type: "project" })
        .then(async (res) => {
          if (res)
  ...
  return (
    <>
      <Layout className={root}>
        <PopupSucces
          isOpen={isSuccess}
          message={pathCategory === "edit-file" ? "Doc Project Berhasil Diubah" : "Knowledge Base Berhasil Ditambah"}
        ...
        <Content style={{ marginTop: 20 }}>
          <Barlow36 style={{ fontWeight: 500 }}>Doc Project</Barlow36>
        </Content>
          ...
          <GeneralCard variant="outlined" style={{ padding: 20 }}>
            <div className={flexTitle}>
              ...
              <input
                ...
                placeholder="Masukan Judul Doc Project"
                value={inputTitle}
              />
              {!inputTitle && (
...
export default AddFileDocProject;
