  ...
  return (
    <>
      <Layout className={root}>
        <PopupSucces
          isOpen={isSuccess}
          message={pathCategory === "edit-file" ? "Doc Project Berhasil Di ubah" : "Doc Project Berhasil Ditambah"}
        ...
        <Content style={{ marginTop: 20 }}>
          <Barlow36 style={{ fontWeight: 500 }}>Doc Control</Barlow36>
        </Content>
          ...
          <GeneralCard variant="outlined" style={{ padding: 20 }}>
            <div className={flexTitle}>
              ...
              <input
                ...
                placeholder="Masukan Judul Doc Control"
                value={inputTitle}
              />
              {!inputTitle && (
...
export default AddFileDocControl;
