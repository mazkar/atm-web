  ...
  const FetchData = async () => {
    try {
      const result = await axios.post(
        `${process.env.REACT_APP_API_FILE_MANAGEMENT}/getFileDetailDocumentLegality`,
        {
          siteNewAtmId: atmId,
        }
      );
            ...
            <Grid container direction="row" alignItems="flex-start" spacing={2}>
              <Grid item xs={3}>
                <Typography
                  ...
                  style={{ color: "#2B2F3C", textAlign: "left" }}
                >
                  Document Name
                </Typography>
              </Grid>
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  >
                    ...
                    <Grid item xs={1} style={{ textAlign: "center" }}>
                      <img
                        src={item.available ? GreenCheck : Cross}
