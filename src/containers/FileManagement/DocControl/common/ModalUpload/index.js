...
const ModalUpload = ({ isOpen, onClose, value, onChange, onSubmit }) => {
  const {
    root,
    modal,
    paper,
          ...
          >
            ...
            <Grid container justify="center" direction="row" spacing={10}>
              <Grid item className={textField}>
                ...
                >
                  Upload File Document Control :
                </Typography>
                <input
                  // accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel,image/*,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
                  id="fileFile"
                  type="file"
                  accept="application/pdf, image/*, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.openxmlformats-officedocument.wordprocessingml.document"
                  onChange={onChange}
                  ref={inputFileRef}
                  style={{
                    width: "0.1px",
