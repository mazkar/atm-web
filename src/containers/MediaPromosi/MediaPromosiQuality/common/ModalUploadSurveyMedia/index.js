...
import { doUploadSurveyMediaPromosi } from '../../../services';
...
const ModalUploadSurveyMedia = ({ isOpen, onClose, onSuccesUpload }) => {
  const {
    root,
    modal,
    paper,
  ...
  const handleSubmit = (event) => {
    ...
    if(!fileFile){
      ...
      doUploadSurveyMediaPromosi(loaderHandler, formData)
        .then((response) => {
...
ModalUploadSurveyMedia.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onSuccesUpload: PropTypes.func.isRequired,
};

export default ModalUploadSurveyMedia;
