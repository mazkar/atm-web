...
function ChartObjectPajak(props) {
  const classes = UseStyles();
  const { dataDone, dataOpen, total } = props;
...
ChartObjectPajak.PropTypes = {
  dataDone: PropTypes.number,
  dataOpen: PropTypes.number,
  total: PropTypes.number,
};

export default ChartObjectPajak;
