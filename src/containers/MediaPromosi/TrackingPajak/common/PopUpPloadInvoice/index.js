...
import { doUploadPembayaran } from "../../../services";
...
const PopUpUploadInvoice = ({ isOpen, onClose, setIsOpenReminder }) => {
  const {
    root,
    modal,
    paper,
  ...
  const handleSubmit = (event) => {
    ...
    doUploadPembayaran(loaderHandler, formData)
      .then((response) => {
  ...
  return (
    <div className={root}>
      ...
      <PopupSucces
        isOpen={isSuccess}
        onClose={onSuccess}
        message="Upload Pembayaran Berhasil Dilakukan!"
      />
    </div>
  );
};
