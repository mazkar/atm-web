...
const ModalConfirmation = ({ isOpen, onClose, onNext, message, title }) => {
  const {
    modal,
    paper,
    closeIcon,
    ...
    >
      <Box className={paper}>
        ...
        <Grid container justify="space-between" className={buttonContainer}>
          <Grid item>
            <ChkyButtons buttonType="redOutlined" onClick={onClose} style={{textTransform: 'capitalize'}}>  No  </ChkyButtons>
          </Grid>
          <Grid item>
            <ChkyButtons onClick={onNext} style={{textTransform: 'capitalize'}}> Yes </ChkyButtons>
          </Grid>
        </Grid>
      </Box>
    </Modal>
