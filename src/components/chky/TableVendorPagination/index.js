          ...
          if (headCell.label !== ""){
            if (cellOption[index] !== "hide") {
                ...
                <TableCell
                    key={headCell.id}
                    align={
                    index !== 0 ? "center" : isFirstColumnAlignLeft ? "left" : "center"
                    }
                ...
                >
                    ...
                    IconComponent={() => orderBy === headCell.id ? (
                        <img style={{height: "80%"}} src={order.toLowerCase() === "asc" ? DownArrow : UpArrow}/>
                    ) : (
                        <img style={{height: "80%"}} src={UpArrow}/>
                    )}
                    style={{
                        width: "auto",
                        display: "flex",
                      ...
                      >
                        ...
                        const theAlign = leftAlignBody?.includes(j) ? "left" : "center";
                          if (cellOption[j] !== "hide") {
                              if (Object.values(row)[j] !== null){
                                if (Object.values(row)[j].length > 20){
                                    return (
