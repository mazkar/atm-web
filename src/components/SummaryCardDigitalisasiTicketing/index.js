...
const SummaryCardDigitalisasiTicketing = ({data}) => {
...
SummaryCardDigitalisasiTicketing.propTypes = {
  data: PropTypes.object
};

SummaryCardDigitalisasiTicketing.defaultProps = {
...
export default SummaryCardDigitalisasiTicketing;
