...
const SummaryCardDigitalasiResult = ({data}) => {
  ...
  return (
    <Grid container alignItems='start' style={{flexWrap: "nowrap"}}>
      <Grid item xs={3} className={classes.wrapper}>
        ...
        <RowData label="Survey Delay" value={data.leftCard?.surveyDelay} icon={<History />} color={Green} />
...
SummaryCardDigitalasiResult.propTypes = {
  data: PropTypes.object
};

SummaryCardDigitalasiResult.defaultProps = {
...
export default SummaryCardDigitalasiResult;
