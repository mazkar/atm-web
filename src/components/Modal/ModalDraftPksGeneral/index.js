...
const ModalDraftPksFreeSewa = (props) => {
  ...
  function validateForm(){
    ...
    if (!dataRequest.boothType) { arrError.push("terletak di ... Gedung"); } 
    if (!dataRequest.buildingName) { arrError.push("Nama Gedung"); } 
    // PASAL
    if (!dataRequest.maintenanceCost) { arrError.push("Pasal 2. Biaya Maintenance IKG"); } 
    if (!dataRequest.lineTlp) { arrError.push("Pasal 5. Jumlah Line Telpon"); } 
    if (!dataRequest.branches) { arrError.push("Pasal 14. Cabang"); } 
            ...
            <div className={classes.girdAreaContent}>
              ...
              <div className={classes.deskripsiArea}>
                ...
                <Typography className={classes.deskripsi}>
                  ...
                  selaku Direktur Utama, dari dan karenanya bertindak untuk dan atas nama{" "}<b>{dataRequest.nameBusinessEntity ? dataRequest.nameBusinessEntity : "-"}</b>
                  , yang berkedudukan di{" "} <b>{dataRequest.locationName ? dataRequest.locationName : "-"}</b>
                  , selanjutnya disebut <b>"PEMILIK/ PIHAK PERTAMA".</b>
                </Typography>
              </div>
              ...
              <div className={classes.deskripsiArea}>
                ...
                <Typography className={classes.deskripsi}>
                  ...
                  , masing-masing selaku Karyawan Pimpinan PT Bank CIMB Niaga Tbk yang dalam hal ini bertindak berdasarkan Surat Kuasa No.290/Ska/DIR/IV/2020 - tertanggal 17 April 2020 dan Surat Kuasa No. No.329/Ska/DIR/VII/2021 – tertanggal 22 Juli 2021, selanjutnya disebut <b>"PENYEWA / PIHAK KEDUA"</b>
                </Typography>
              </div>
              ...
              >
                <Grid item className={classes.deskripsi}>
                  <Grid container direction='row'>
                    ...
                    <Grid item xs={11}>
                      <Typography className={classes.subDeskripsi}>
                        Bahwa PEMILIK adalah pemegang hak atas tanah berikut bangunan diatasnya berlantai 
                        ...
                        tertanggal 
                        {/* <AdvancedSmallInput className={classes.inputAdv} stateVar={dataRequest.imbDate} stateModifier={(val)=>handleDataRequest(val, "imbDate")}/> */}
                        <div className={classes.datePksWrapper}>
                          <DateSelectTimestamp 
                        ...
                        {/* <div className={classes.datePksWrapper}>
                          <DateSelectTimestamp 
                            value={dataRequest.letterDate} 
                            popupStyle={{ zIndex: 1700 }}
                            handleChange={(val) => {
                              handleDataRequest(val, "letterDate");
                            }}/>
                        </div> */}
                        No.  
                        ...
                        yang dimiliki PEMILIK  berdasarkan  
                ...
                <Grid item className={classes.deskripsi}>
                  <Grid container direction='row'>
                    ...
                    <Grid item xs={11}>
                      <Typography className={classes.subDeskripsi}>
                      Bahwa PEMILIK setuju untuk menyewakan kepada PENYEWA dan PENYEWA 
                      setuju menyewa Ruangan Sewa seluas{" "} <b>
                        ...
                        Gedung {" "} 
                        <AdvancedSmallInput className={classes.inputAdv} stateVar={dataRequest.buildingName} stateModifier={(val)=>handleDataRequest(val, "buildingName")}/>
                        tersebut di atas selanjutnya disebut <b>"RUANGAN SEWA"</b>.
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
              ...
              <div className={classes.deskripsiArea}>
                <Typography className={classes.subDeskripsi}>
                  Selanjutnya kedua pihak sepakat bahwa perjanjian sewa menyewa ini dilangsungkan dan diterima oleh kedua belah pihak dengan syarat-syarat dan ketentuan-ketentuan sebagai berikut: 
                </Typography>
              </div>
              ...
              <div>
                Demikian  Perjanjian ini,  dibuat  dalam rangkap 2 (dua)  bermeterai cukup  dan mempunyai kekuatan hukum yang sama,  masing-masing  pihak  memperoleh  1 eksemplar. 
              </div>
              <br />
              <Table size="small">
                <TableRow>
                ...
                <TableRow>
                  <TableCell style={{borderBottom: 'none', padding:'unset'}}>
                    <Typography style={{textAlign: 'center', fontSize: '13px',fontWeight: 700}}>{dataRequest.ownerInfo? dataRequest.ownerInfo: "-"}</Typography>
                  </TableCell>
                  <TableCell  style={{borderBottom: 'none', padding:'unset'}}>
