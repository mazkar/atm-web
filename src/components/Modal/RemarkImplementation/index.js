...
const RemarkImplementation = ({ isOpen, onClose, rowToShow, type, rType }) => {
  ...
  useEffect(() => {
    if (isOpen === true) {
      ...
      const request = { taskType: type, taskId: rowToShow };
      const headers = {
      ...
      try {
        ...
        axios
          .post(
            `${process.env.REACT_APP_API_DOMAIN}/implementationservice/v1/getRemarkNote`,
            request,
            headers
          )
          .then((res) => {
  ...
  const handleSubmit = () => {
    ...
    try {
      ...
      axios
        .post(
          `${process.env.REACT_APP_API_DOMAIN}/implementationservice/v1/submitRemarkNote`,
          request,
          headers
        )
        .then((res) => {
...
RemarkImplementation.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
};

export default RemarkImplementation;
